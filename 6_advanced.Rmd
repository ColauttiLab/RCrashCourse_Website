...
Notice the use of special characters with the backslash `\` character, along with subscripts `_` and superscripts `_` with the super/subscripted text in curly brackets `{}`
