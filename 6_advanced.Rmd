...
R Markdown is a powerful format for making high-quality reports. You can embed code and all kinds of output, including graphs. Here we'll cover just the basics, but a complete guide to R Markdown is available online from [Yihui Xie, J. J. Allaire and Garrett Grolemund](https://bookdown.org/yihui/rmarkdown/)
...
> NOTE: If you don't see a menu option for R Markdown, you may need to install it:
...
Add skip an extra line to start a new paragraph.

### Formatted text

Format text with `*` or `_`
...
Links have a special format. The text you want the user to see goes in square brackets, followed by the file or html link in regular brackets, with no space in between: 
